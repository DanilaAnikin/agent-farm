...
export function loadConfig(): FarmConfig {
  return {
    farmDailyCapUsd: num("FARM_DAILY_CAP_USD", 0.6),
    ...
    perAttemptBudgetUsd: num("PER_ATTEMPT_BUDGET_USD", 0.05),
    maxWorkersTotal: num("MAX_WORKERS_TOTAL", 1),
    maxTaskAttempts: num("MAX_TASK_ATTEMPTS", 3),
    maxBestOfN: num("MAX_BEST_OF_N", 1),
    ...
    refillMaxRoundsPerDay: num("REFILL_MAX_ROUNDS_PER_DAY", 1),
    refillMaxTasksPerRound: num("REFILL_MAX_TASKS_PER_ROUND", 2),
